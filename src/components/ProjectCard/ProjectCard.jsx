const ProjectCard = ({ project }) => {
  return (
    <div className='bg-card rounded-xl flex flex-col items-center'>
      <img
      ...
      <div className='flex flex-col justify-between p-4 flex-grow'>
        <div>
          <h1 className='text-cardFont text-[28px] font-bold text-center tracking-tighter mb-2'>
            {project.title}
          </h1>
          <p className='text-cardFont text-[18px] tracking-tighter mb-2'>
            {project.description}
          </p>
        </div>
        <div className='flex flex-col justify-between'>
          <p className='text-cardFont text-[16px] tracking-tighter mb-2'>
            Tecnologías:{' '}
            <span className='text-[14px] underline'>{project.techStack}</span>
          </p>
          <a
            className='text-text text-[16px] tracking-tighter flex items-center underline'
            href={project.link}
            target='_blank'
